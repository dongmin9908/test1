	...
	<div class="form-group" style="display: none;">
	   ...
	   value='<c:out value="${board.writer}" />'  readonly="readonly">            
		...
		<div class="form-group">
		  ...
		  <label>등록일</label> 
		  <input class="form-control tipregDate" style="width: 31%; display: inline-block !important;" name='regDate'
		  value="<fmt:formatDate pattern="yyyy/MM/dd"  value="${board.regdate}" />"    readonly="readonly">            

		  <label>수정일</label> 
		  <input class="form-control tipupdateDate" style="width: 31%; display: inline-block !important;" name='updateDate'
...
$(document).ready(function() {
  (function(){
    ...
    $.getJSON("/tip/getAttachList", {bno: bno}, function(arr){
