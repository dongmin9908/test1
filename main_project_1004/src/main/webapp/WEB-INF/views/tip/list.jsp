...
<head>
	...
	<!-- tip 실종 아동 제보 CSS -->
	<link href="../resources/boardcss/tip.css" rel="stylesheet">
...
<header>
    ...
    <div id="wrapper" class="tip_wrapper">

        <!-- Navigation -->
        

        <div id="page-wrapper" class="tip_page">
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header" style="text-align: center;">실종 아동 제보</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-lg-12">
						<form id="searchForm" action="/tip/list" method="get">
						<select name="type">
