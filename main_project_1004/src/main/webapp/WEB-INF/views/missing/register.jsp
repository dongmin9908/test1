...
.bigPicture {
   ...
   align-items: center;
         ...
         <div class="row">
            <div class="col-lg-12">
               <h1 class="page-header">실종 아동 등록하기</h1>
            </div>
            <!-- /.col-lg-12 -->
         </div>
         <!-- /.row -->
         ...
         <div class="row">
            <div class="col-lg-12">
               <div class="panel panel-default">
                  ...
                  <div class="panel-heading">실종 아동 등록하기 페이지입니다.</div>
                  <!-- /.panel-heading -->
        ...
        input type hidden 형식으로 아래와 같이 추가해 줍니다.  -->
                        ...
                        <label>제목</label> <input class="form-control" name='title'>
                           <table id="miss_table">
                              <tr>
                                 <td><label>이름</label> <input class="form-control" name='htype'></td>
                                 <td><label>나이(세)</label> <input class="form-control" name='age'></td>
                                 <td><label>국적</label> <input class="form-control" name='country'></td>
                              </tr>
                              <tr>
                                 <td><label>키(cm)</label> <input class="form-control" name='cm'></td>
                                 <td><label>몸무게(kg)</label> <input class="form-control" name='kg'></td>
                                 <td><label>체격</label> <input class="form-control" name='tong'></td>
                              </tr>
                              <tr>
                                 <td><label>얼굴형</label> <input class="form-control" name='face'></td>
                                 <td colspan="2"><label>두발 색상 및 형태</label> <input class="form-control" name='hcolor'></td>
                              </tr>
                              <tr>
                                 <td colspan="3"><label>착의 의상</label> <input class="form-control" name='outfit'></td>
                              </tr>
                              <tr>
                                 <td><label>발생 일시 (xxxx(년)/xx(월)/xx(일))</label> <input class="form-control" name='aday'></td>
                                 <td colspan="2"><label>발생 장소</label> <input class="form-control" name='aplace'></td>
                              </tr>
                           </table>
