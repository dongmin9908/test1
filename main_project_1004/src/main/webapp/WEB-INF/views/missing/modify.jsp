...
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <form role="form" action="/missing/modify" method="post">
     ...
     <input type='hidden' name='amount' value='<c:out value="${cri.amount}"/>'>      
      ...
      <td>
      <div class="form-group">
          <label>이름</label> <input class="form-control" name='htype' value='<c:out value="${board.htype}" />'
             readonly="readonly">
        </div></td>
       <td><div class="form-group">
          <label>나이(세)</label> <input class="form-control" name='age' value='<c:out value="${board.age}" />'
             readonly="readonly">
        </div></td>
        <td>
         <div class="form-group">
          <label>국적</label> <input class="form-control" name='country' value='<c:out value="${board.country}" />'
             readonly="readonly">
        </div></td>       
        </tr>
        <tr>
         <td><div class="form-group">
          <label>키(cm)</label> <input class="form-control" name='cm' value='<c:out value="${board.cm}" />'
             readonly="readonly">
        </div></td>
        
         <td><div class="form-group">
          <label>몸무게(kg)</label> <input class="form-control" name='kg' value='<c:out value="${board.kg}" />'
             readonly="readonly">
        </div></td>
        <td>
         <div class="form-group">
          <label>체격</label> <input class="form-control" name='tong' value='<c:out value="${board.tong}" />'
             readonly="readonly">
        </div></td>
        </tr>
        <tr>
         <td><div class="form-group">
          <label>얼굴형</label> <input class="form-control" name='face' value='<c:out value="${board.face}" />'
             readonly="readonly">
        </div></td>
        
         <td colspan="2"><div class="form-group">
          <label>두발 색상 및 형태</label> <input class="form-control" name='hcolor' value='<c:out value="${board.hcolor}" />'
             readonly="readonly">
        </div></td>
        </tr>
        <tr>
         <td colspan="3"><div class="form-group">
          <label>착의 의상</label> <input class="form-control" name='outfit' value='<c:out value="${board.outfit}" />'
             readonly="readonly">
        </div></td>
        </tr>
        <tr>
         <td><div class="form-group">
          <label>발생 일시 (xxxx(년)/xx(월)/xx(일))</label> <input class="form-control" name='aday' value='<c:out value="${board.aday}" />'
             readonly="readonly">
        </div></td>
        <td colspan="2">
         <div class="form-group">
          <label>발생 장소</label> <input class="form-control" name='aplace' value='<c:out value="${board.aplace}" />'
             readonly="readonly">
        </div></td>
        </tr>
...
<c:if test="${pinfo.username eq board.writer}">
  ...
  <button type="submit" data-oper='remove' class="btn btn-danger" style="float: right;">글삭제</button>
</c:if>
</sec:authorize>
...
$(document).ready(function() {
   ...
   $('button').on("click", function(e) {
      ...
      if(operation === 'remove'){
         formObj.attr("action", "/missing/remove");
         ...
         formObj.attr("action", "/missing/list").attr("method", "get");
