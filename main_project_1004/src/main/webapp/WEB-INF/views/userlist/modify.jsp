...
<body>
	...
	<div id="wrapper" class="notice_wrapper">
		...
		<div id="page-wrapper" class="notice_page">
			...
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header" style="text-align: center;">공지사항 수정하기</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-heading">관리자용 공지사항 수정페이지 입니다.</div>
						<!-- /.panel-heading -->
						<div class="panel-body">

							<form role="form" action="/userlist/modify" method="post">
        ...
        <textarea class="form-control" rows="3" name='content' >
           <c:out value="${board.content}" />
								...
								<div class="form-group">
									...
									<label>등록일</label> <input class="form-control noticeregDate"
										style="width: 31%; display: inline-block !important;"
										name='regDate'
										value="<fmt:formatDate pattern="yyyy/MM/dd"  value="${board.regdate}" />"
										readonly="readonly"> <label>수정일</label> <input
										class="form-control noticeupdateDate"
										style="width: 31%; display: inline-block !important;"
										name='updateDate'
					...
					<sec:authorize access="isAuthenticated()">
						...
						<c:if test="${pinfo.username eq board.writer}">
							<button type="submit" data-oper='modify' class="btn btn-default"
								style="float: right; margin: 0 5px;">글수정</button>
							<button type="submit" data-oper='remove' class="btn btn-danger"
								style="float: right; margin: margin: 0 0 0 5px;">글삭제</button>
						</c:if>
					</sec:authorize>
							...
							$('button').on(
									...
									function(e) {
										...
										if (operation === 'remove') {
											...
											// 변경합니다. '/userlist/list'로의 이동은 아무런 파라미터가 없기 때문에
