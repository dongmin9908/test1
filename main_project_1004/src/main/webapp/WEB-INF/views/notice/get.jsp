...
<!-- notice 공지사항 CSS -->
<link href="../resources/boardcss/notice.css" rel="stylesheet">
...
<body>
	...
	<div id="wrapper" class="notice_wrapper">

		<!-- Navigation -->


		<div id="page-wrapper" class="notice_page">
          ...
          <label>Bno</label> <input class="form-control" name='bno'
             value='<c:out value="${board.bno}" />' readonly="readonly">
							...
							<div class="form-group">
								<label class="noticecontent">제목</label> <input
									class="form-control boardtitle" name='title'
									value='<c:out value="${board.title}" />' readonly="readonly">

								<label>작성자</label> <input style="text-align: center;"
									class="form-control boardwriter" name='writer'
          ...
          <textarea class="form-control" rows="3" name='content'
            readonly="readonly"><c:out value="${board.content}" /></textarea>
							...
							<!-- 
<button data-oper='modify' class="btn btn-default" onclick="location.href='/notice/modify?bno=<c:out value="${board.bno}" /> '">Modify 수정!</button>
 -->
        ...
        -->
							...
							<!-- <button data-oper='list' class="btn btn-info" onclick="location.href='/notice/list'">List 보여주세요!</button> -->

							<!-- page 317 jsp 소스 코딩 시작 : Page345 조회 페이지에서 검색 처리 jsp 소스 추가 코딩 시작 -->
							<form id='operForm' action="/userlist/modify" method="get">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="panel panel-default">
									...
									<div class="panel-heading">글 내용</div>
									<!-- /.panel-heading -->
									<div class="panel-body">
                    ...
                    로그인하지 않은 사용자는 New Reply 버튼이 보이지 않게 됩니다  -->
							...
							<sec:authorize access="isAuthenticated()">
								<button id="addReplyBtn"
									class="btn btn-primary btn-xs pull-right">댓글 쓰기</button>
							</sec:authorize>
						</div>
                ...
                <li class="left clearfix" data-rno='12'>
                 ...
                 -->
					...
					<button data-oper='list' class="btn btn-info"
						...
						style="float: right; margin: 0 5px;">목록</button>
				</div>
...
// 바깥쪽으로 빼두어 매번 jQuery를 호출하지 않도록 합니다.
   ...
   */
   ...
   // 웹프로젝트 구동 후 http://localhost:9005/notice/list 웹 주소 입력 
   ...
   */
   ...
   $(document).ready(function() {
      ...
      $("button[data-oper='modify']").on("click", function(e) {
         ...
         operForm.attr("action", "/userlist/modify").submit();
      });
...
$(document).ready(function(){
     ...
     (function(){
       ...
       var bno = '<c:out value="${board.bno}"/>';
         ...
         $.getJSON("/userlist/getAttachList", {bno: bno}, function(arr){
