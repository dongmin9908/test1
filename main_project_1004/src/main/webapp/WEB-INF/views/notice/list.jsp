...
<body>
	...
	<div id="wrapper" class="notice_wrapper">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<table class="table table-striped table-bordered table-hover">
								<thead>
									<tr class="notice_list_font_size">
								...
								<c:forEach items="${list}" var="board">
									...
									<tr class="notice_list_font_size">
										...
										<%-- <td><a href='/notice/get?bno=<c:out value="${board.bno}"/>'><c:out value="${board.title}"/></a></td> --%>

										<!-- Page 314 아래 jsp 소스 코딩할 때 아래 소스 추가 코딩 시작 -->
										<td><a class='move' href='<c:out value="${board.bno}"/>'>
												<c:out value="${board.title}" /> <!-- Page 486 소스 코딩 추가 -->
												<b style="display: none;">[<c:out value="${board.replyCnt}" /> ]
											</b>
										</a></td>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel">게시물</h4>
									</div>
		...
		<script type="text/javascript">
			...
			// 저장되었기 때문에 한 번도 사용된 적이 없다면 사용자가 "/notice/list"를 호출하거나,
			...
			$(document)
					.ready(
							function() {
								...
								// 실행 확인은 웹 프로젝트 실행 후 '/notice/register'를 이용해서 새로운 게시물을 작성하고
								// 나면 자동으로 '/notice/list'로 이동하면서 모달창이 보이게 됩니다.
								checkModal(result);
								...
								$("#regBtn").on("click", function() {
									self.location = "/userlist/register";
								});
