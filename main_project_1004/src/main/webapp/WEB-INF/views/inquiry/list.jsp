...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header" style="text-align: center;">문의하기</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<table class="table table-striped table-bordered table-hover">
					<thead>					
						<tr class="inquiry_list_font_size">
					...
					<c:forEach items="${list}" var="board">
						...
						<tr class="inquiry_list_font_size">
							...
							<td><a class='move' href='<c:out value="${board.qno}"/>'>
